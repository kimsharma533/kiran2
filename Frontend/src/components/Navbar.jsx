...
function Navbar() {
  ...
  return (
    ...
    sticky
    ?"sticky-navbar shadow-md bg-base-200  dark:bg-slate-600 dark:text-white duration-300transition-all ease-in-out"
    :"" 
    }`}>
<div className="navbar ">
  ...
  <label className="px-3 py1 border rounded-md flex items-center gap-2">
